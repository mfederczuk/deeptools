...
## [v2.1.0-rc01] - 2025-10-22 ##

[v2.1.0-rc01]: <https://github.com/mfederczuk/deeptools/releases/v2.1.0-rc01>

The changes of the [v2.0.0-rc02](#v200-rc02---2025-10-22) release were merged into this release.
...
* The type [`GenericKey`](src/types.ts) is deprecated in favor of the built-in type `PropertyKey`.  
  `PropertyKey` is identical to the previous definition of `GenericKey`. `GenericKey` now is simply an alias for
  `PropertyKey`
